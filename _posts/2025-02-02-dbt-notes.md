...
# The Complete dbt (Data Build Tool) Bootcamp: Zero to Hero
 ...
 To start, I've taken a Udemy course as an introduction to dbt. This is the course I've taken: [The Complete dbt (Data Build Tool) Bootcamp: Zero to Hero](https://www.udemy.com/course/complete-dbt-data-build-tool-bootcamp-zero-to-hero-learn-dbt/). Here is the repo where I've been doing the hands-on throughout the course: [dbtlearn](https://github.com/maryletteroa/dbtlearn). I've started the course on Jan 24, and finished on Feb 2. (Sharing my [certificate](https://www.udemy.com/certificate/UC-0f2c2844-5932-46af-8ba8-85ad0ce0c8ae/).) I'm hoping these notes would be a good reference in the future.
