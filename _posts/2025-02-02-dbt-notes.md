...
I've recently created a [learning log for this year (2025)]({% link _posts/2025-01-24-2025-learning-log.md %}). The first topic that I wanted to go over is dbt (data-build-tool). Here are some of my notes, in reverse chronological order.
