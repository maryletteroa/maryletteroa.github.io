...
I've recently created a [learning log for this year (2025)]({% link _posts/2025-01-24-2025-learning-log.md %}). The first topic that I wanted to do a deep-dive on is dbt (data-build-tool). Here are some of my notes, in reverse chronological order.

Reference:
- This is the course I've taken: [The Complete dbt (Data Build Tool) Bootcamp: Zero to Hero](https://www.udemy.com/course/complete-dbt-data-build-tool-bootcamp-zero-to-hero-learn-dbt/)
    - Here is the repo where I've been doing the hands-on throughout the course: [dbtlearn](https://github.com/maryletteroa/dbtlearn)
    - Sharing my certificate: [The Complete dbt (Data Build Tool) Bootcamp: Zero to Hero](https://www.udemy.com/certificate/UC-0f2c2844-5932-46af-8ba8-85ad0ce0c8ae/)

Aside from the course, I'm also putting more materials or notes here about dbt as I go along. 
