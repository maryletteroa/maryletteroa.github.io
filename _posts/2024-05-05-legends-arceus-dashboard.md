...
Here's a quick follow up to the [first Pokemon dashboard]({% post_url pokemon-dashboard-(first-generation) %}) I've made. (I keep doing this because this has been so much fun for me 😁). I discussed some aspects about the game in this post so 📢 SPOILER ALERT! up ahead.
