...
- [Apache Spark]({% link _posts/2025-04-28-Apache-Spark.md %})

## 80: 2025-07-278 (Monday) - Query plan and optimization

I reviewed query plans and methods to optimize SQL code.  
...
Adding `with recompile` when creating stored procedures results in SQL server to create a new plan guide every time the stored proc runs (if not, it will use the plan guide it generated on its first run).  
...
Resources:  
This book [AI Engineering](https://www.oreilly.com/library/view/ai-engineering/9781098166298) by Chip Huyen is a good reference. [DeepLearning.ai](https://learn.deeplearning.ai) also contains a range of courses on this topic.
...
I've started reviewing Databricks as it's been a while, and there is now a free edition that is unattached to a cloud provider. I've following this course [Databricks Certified Data Engineer Associate - Ultimate Prep](https://www.udemy.com/course/databricks-certified-data-engineer-associate-ultimate-prep/?couponCode=ST16MT230625G2).
...
- `pre-commit install`
- only checks against staged files excluding `.yaml` files or config files
...
Use with [darker](https://github.com/akaihola/darker) if wanting to lint only within changed regions since a commit.
...
Databricks has released a [Free Edition](https://www.databricks.com/learn/free-edition) which includes full access to most features of the platform albeit limited to smaller compute and warehouse sizes, and other fair use [limits](https://docs.databricks.com/aws/en/getting-started/free-edition-limitations). It does not require a credit card to sign up, and comes equipped with environment that enables data science, AI, and ML application development.
...
- [Radon](https://radon.readthedocs.io/en/latest/intro.html)
    - flake8 plugin; set line in `.flake8` file e.g. `radon-max-cc = 10` 
...
Resources
- [Refactoring](https://www.refactoring.com) by Martin Fowler
...
Installed iTerm2 (finally), and  [OhMyZsh](https://ohmyz.sh/) which is a plugin manager for `zsh` (z shell), and requires prior `zsh` installation
...
Resources
 - [Make your life easier with iTerm2](https://www.youtube.com/watch?v=P-Etw6aa2cY)
 - [Taking Python to Production: A Professional Onboarding Guide](https://www.udemy.com/course/setting-up-the-linux-terminal-for-software-development/)
...
Here are the rest of the notes: [Apache Spark]({% link _posts/2025-04-28-Apache-Spark.md %})


## 49. 2025-04-23 (Wednesday) -  Migration essentials for Azure and AI workloads

Topic: Accelerate your migration, modernization, and innovation journey to Azure ([link](https://learn.microsoft.com/en-us/training/modules/accelerate-azure-migration-journey/))

[Cloud adoption framework](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/) - collection of documentation, implementation guidance, best practices, and tools from Microsoft to accelerate cloud adoption journey
