...
## 23. 2025-02-25 (Tuesday) - Tables types in Snowflake, Zero-copy cloning, Swapping
...
Objects in a permanent database can be permanent, transient or temporary tables. All objects in a transient database can be either transient or temporary tables not permanent.
