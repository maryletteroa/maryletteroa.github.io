...
## 2: 2025-01-25 (Sat)
Today,  I learned about dbt models and worked on writing and materializing them into Snowflake.
...
type | use | don't use
-| - | - 
view | light weight representation; the data isn't being reused often | the model is being read several times
table | the model is being read repeatedly | single-used models; incremental load
incremental | fact, even tables; appends to tables | update historical records
