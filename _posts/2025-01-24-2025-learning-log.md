...
Separate virtual warehouse according to different workloads or user groups e.g. dedicated virtual warehouses to BI Team, Data Science Team, and Marketing Department

Consider:
- Not to many warehouses such that underutilization occurs
- Refine classifications as work patterns change

### Scaling up vs Scaling Out
| Scaling up | Scaling out |
| - | - |
| Increasing the size of virtual warehouses | Using additional warehouses / multi-cluster warehouses |
