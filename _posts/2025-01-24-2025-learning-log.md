...
5. In cloud provider, set Policies / Permissions in cloud provider and add appropriate role of the object from Snowflake. The values for these are returned from `DESC`
